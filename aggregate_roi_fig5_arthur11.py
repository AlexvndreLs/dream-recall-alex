...
E1. MAPPING ELECTRODE -> ROI (ecart assume, source d'Arthur introuvable). Arthur
    ...
    Arthur. De plus Arthur avait 12 electrodes (montage demi-gauche), nous 19.
...
# MAPPING 11 ELECTRODES = montage d'Arthur (12 elec) MOINS M1.
# Arthur : Fz,Cz,Pz,Fp1,F3,FC1,C3,T3,CP1,P3,M1,O1 (montage demi-gauche, 12 elec).
# M1 (mastoide) EXCLU : identite non confirmee dans tes donnees (misc1/2/3 non
# identifies, cf historique + message Arthur en attente) ET pas de features PSD
# extraites dessus. Donc 11 electrodes exploitables. Prefrontal/temporal/occipital
# tombent a UNE seule electrode (Fp1/T3/O1) : leur acc de ROI = acc de cette electrode.
ROIS = {
    "prefrontal":      ["Fp1"],
    "fronto-central":  ["Fz", "F3", "FC1"],
    "temporal":        ["T3"],
    "centro-parietal": ["Cz", "C3", "CP1", "Pz", "P3"],
    "occipital":       ["O1"],
}
...
def main():
    ...
    out = args.in_dir / f"fig5_roi_arthur11_{args.state}.npz"
