...
# IDs BIDS des sujets inclus dans l'analyse uniquement
SUBJECT_IDS_ANALYSIS = [
    f"{i:02d}" for i in sorted(HR_SUBJECTS | LR_SUBJECTS)
]

# per_s19 est une copie de per_s29 sur le disque -> blacklisté
...
#
# Mis à jour après preprocessing (preprocess_subject.py) :
...
N_SAMPLES      = int(SFREQ_PREPROC * EPOCH_DURATION)  # 7500 (au lieu de 30000 à 1000Hz)
...
FEATURE_KEYS = (
    ...
    + ["cov"]                              # matrice de covariance temporelle
